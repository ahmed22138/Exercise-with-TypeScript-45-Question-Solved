...
// task 3
// lower case
let person_Name = "Muhammad Ahmed";
...
// task 11
let names = ['Ahmed', 'Anas', 'Hasseb', 'Abbas'];
for (let i = 0; i < names.length; i++) {
    console.log(names[i]);
}
// task 12
let names1 = ['Ahmed', 'Anas', 'Hasseb', 'Abbas'];
const message2 = 'Welcome to TyppeScript class: ';
for (let i = 0; i < names.length; i++) {
...
let new_Guest = 'Hasseb';
Guest_List[0] = new_Guest;
for (let i = 0; i < Guest_List.length; i++) {
    console.log('Dear invite ' + Guest_List[i] + ',\nIt is our pleasure to invite you in our party.\nThank you!\n');
}
console.log('Mr. '.concat(absent_Guest), 'is not coming to the party.');
let Guest_List1 = ['Yasir', 'Abdullah', 'Dawood'];
// for(let i=0; i<Guest_List.length; i++) {
//     console.log('Dear invite ' + Guest_List[i] +  ',\nIt is our pleasure to invite you in our party.\nThank you!\n');
// }
let absent_Guest1 = 'Yasir';
let new_Guest1 = 'Hasseb';
...
// task 17
let guest_List2 = ['Yasir', 'Abdullah', 'Dawood'];
// for(let i=0; i<Guest_List.length; i++) {
//     console.log('Dear invite ' + Guest_List[i] +  ',\nIt is our pleasure to invite you in our party.\nThank you!\n');
// }
let absent_Guest2 = 'Yasir';
let new_Guest2 = 'Hasseb';
...
let place = ['Paris', 'Canada', 'America', 'Turkey', 'Dubai'];
...
// task 19
let guest_List3 = ['Yasir', 'Abdullah', 'Dawood'];
// for(let i=0; i<Guest_List.length; i++) {
//     console.log('Dear invite ' + Guest_List[i] +  ',\nIt is our pleasure to invite you in our party.\nThank you!\n');
// }
let absent_Guest3 = 'Yasir';
let new_Guest3 = 'Hasseb';
...
let items = ['Pakistan', 'Lahore', 'Islamabad'];
...
console.log(person);
// task 22
let days = ['Monday', 'Tusday', 'wednesday', 'Thursday', 'Friday', 'Saterday', 'Sunday'];
// console.log(days[7]);
console.log(days[6]);
// task 23
let car = "subaru";
...
// task 29
let favorite_Fruit = ['Mango', 'Apple', 'Orange', 'banana', 'kivi'];
...
let users = ['Admin', 'Alexa', 'Eric', 'Malik', 'Zahid'];
...
// task 31
let users1 = ['Admin', 'Alexa', 'Eric', 'Malik', 'Zahid'];
// if (users.length ===0){
...
// task 34
let favorite_pizza = ['Cremy BBQ', 'Pepperoni', 'veg'];
...
const magician1 = ['ahmed', 'anas', 'abbas'];
...
const magicians2 = ['ahmed', 'anas', 'abbas'];
...
const magicians3 = ['Ahmed', 'Anas', 'Abbas'];
